...
!function(A, e) {
  ...
  return function(A) {
      ...
      function B(o) {
          ...
          return A[o].call(g.exports, g, g.exports, B),
          g.l = !0,
          g.exports
      }
      return B.m = A,
      ...
      var g = B(1)
        ...
        , i = function() {
          return "wakeLock"in navigator && -1 === window.navigator.userAgent.indexOf("Samsung")
      }
        , C = function() {
          function A() {
              var e = this;
          ...
          return o(A, [{
              ...
              value: function() {
                  var A = this;
                  return i() ? navigator.wakeLock.request("screen").then((function(e) {
                      A._wakeLock = e,
                      A.enabled = !0,
                  ...
                  this.enabled = !0,
                  Promise.resolve()) : this.noSleepVideo.play().then((function(e) {
                      return A.enabled = !0,
                      e
                  }
                  )).catch((function(e) {
              ...
              key: "disable",
              value: function() {
                  i() ? (this._wakeLock && this._wakeLock.release(),
