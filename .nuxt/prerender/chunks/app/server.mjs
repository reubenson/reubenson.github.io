import { getCurrentInstance, version, defineComponent, h, inject, computed, unref, Suspense, nextTick, Transition, provide, reactive, ref, resolveComponent, shallowRef, useSSRContext, createApp, toRef, isRef, defineAsyncComponent, onErrorCaptured, withCtx, createVNode } from 'file:///Users/reubenson/Projects/reubenson.github.io/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/reubenson/Projects/reubenson.github.io/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///Users/reubenson/Projects/reubenson.github.io/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Users/reubenson/Projects/reubenson.github.io/node_modules/unctx/dist/index.mjs';
import { hasProtocol, isEqual, parseURL, joinURL } from 'file:///Users/reubenson/Projects/reubenson.github.io/node_modules/ufo/dist/index.mjs';
import { createError as createError$1, sendRedirect } from 'file:///Users/reubenson/Projects/reubenson.github.io/node_modules/h3/dist/index.mjs';
import { useHead, createHead as createHead$1 } from 'file:///Users/reubenson/Projects/reubenson.github.io/node_modules/@unhead/vue/dist/index.mjs';
import { renderDOMHead, debouncedRenderDOMHead } from 'file:///Users/reubenson/Projects/reubenson.github.io/node_modules/@unhead/dom/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter } from 'file:///Users/reubenson/Projects/reubenson.github.io/node_modules/vue-router/dist/vue-router.node.mjs';
import { ssrRenderSuspense, ssrRenderComponent } from 'file:///Users/reubenson/Projects/reubenson.github.io/node_modules/vue/server-renderer/index.mjs';
...
const node_modules_nuxt_dist_head_runtime_lib_vueuse_head_plugin_mjs_D7WGfuP1A0 = defineNuxtPlugin((nuxtApp) => {
  ...
  nuxtApp._useHead = useHead;
  {
    nuxtApp.ssrContext.renderMeta = async () => {
      const { renderSSRHead } = await import('file:///Users/reubenson/Projects/reubenson.github.io/node_modules/@unhead/ssr/dist/index.mjs');
...
const _routes = [
  {
    ...
    file: "/Users/reubenson/Projects/reubenson.github.io/pages/index.vue",
    children: [],
    meta: __nuxt_page_meta,
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/index.35d623ee.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.e0fef3b2.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
